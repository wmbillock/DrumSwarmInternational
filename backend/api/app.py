...
async def lifespan(app: FastAPI):
    ...
    # Test mode: skip heavy initialization (LLM client, metronome, seeder)
    if os.environ.get("DCI_TEST_MODE") == "1":
        yield
        return
...
for _r in [
    ...
    v1_scoreboards_router, v1_drill_books_router, v1_experiments_router,
    v1_images_router, v1_model_strategy_router,
]:
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:5174",
        "http://127.0.0.1:3000",
        "http://tiny-but-mighty.local:5173",
        "http://tiny-but-mighty.local:5174",
        "http://tiny-but-mighty.local:3000",
    ],
